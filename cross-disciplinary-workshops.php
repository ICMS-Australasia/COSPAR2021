    ...
    <div class="container">
        <div class="row py-5">
            <div class="col">
              ...
              <h2>Anchor Sponsor</h2>

              <img src="img/sponsors/lockheed-logo.jpg" class="img-fluid mb-3" width="650">

              <h2 class="mt-5 mb-4"><a href="https://cospar2020.gitlab.io/ml4ss/" target="_blank">Machine Learning for Space Sciences</a></h2>
                <h3>Date: Sunday 31 Jan 2021<br>
                    Time: 09:30 - 13:00 and 14:30 - 18:00
<br>
                    Room: Cockle Bay Room, Level 2, ICC Sydney
                </h3>
                <p>The widespread availability of machine learning (ML) technologies promises to disrupt scientific disciplines.</p>
                <p>Popular open source ML frameworks are not only useful for data-driven model fitting, but also for efficient computation of physics-based models. This COSPAR 2021 workshop is dedicated to showcasing use cases of ML technologies to observational and
                    simulation data.
                </p>
                <p><strong>This includes applications to:</strong></p>
                <ol>
                    <li>satellite imagery classification and image restoration (including super-resolution)</li>
                    <li>space weather prediction</li>
                    <li>exoplanet detection and characterization</li>
                    <li>astrophysical simulations</li>
                    <li>data augmentation</li>
                    <li>compressed sensing and inverse problems</li>
                </ol>
                <p><strong>Speakers</strong></p>
                <div class="row speakers mt-4 mb-4">
                    <div class="chair-image col-4 col-md-2">
                        <img src="img/speakers/m-guhathakurta.png" class="img-fluid">
                    </div>
                    <div class="col col-md-10 chair-text">
                        <h3>Madhulika Guhathakurta</h3>
                        <strong>NASA HQ <br>
                            <em>Machine Learning & Space Science at Frontier Development Lab</em></strong>
                        <p>Dr. Guhathakurta is the Lead Program Scientist for NASA's initiative called "Living With a Star" (LWS) which focuses on understanding and ultimately predicting solar variability and its diverse effects on Earth, human technology and astronauts in space. The systems science behind this new kind of weather outside of Earth's terrestrial atmosphere is known as "Space Weather".
                ...
                <div class="row speakers mt-4 mb-4">
                    <div class="chair-image col-4 col-md-2">
                        <img src="img/speakers/s-ho.png" class="img-fluid">
                    </div>
                    <div class="col col-md-10 chair-text">
                        <h3>Shirley Ho</h3>
                ...
                <p><strong>Technical Organising Committee (TBC)</strong></p>
                <ul>
                    <li>Mark Cheung, Lockheed Martin Advanced Technology Centre, Palo Alto, CA, USA</li>
                    <li>James Parr, NASA Frontier Development Lab (FDL) & FDL Europe</li>
                    <li>Bill Diamond, SETI Institute, Mountain View, CA, USA</li>
                    <li>Andrés Muñoz-Jaramillo, Southwest Research Institute, Boulder, CO, USA</li>
                    <li>Massimo Mascaro, Google Cloud, Mountain View, CA, USA</li>
                    <li>Atılım Güneş Baydin, University of Oxford, UK</li>
                    <li>Rajat Thomas, University of Amsterdam, NL</li>
                </ul>

                <h2 class="mt-5 mb-4"><a href="https://cospar2020.gitlab.io/autonomy/" target="_blank">Autonomy for Future Space Science Missions</a></h2>
                <h3>Date: Monday  1 Feb 2021
                  <br> Time: 09:30 - 13:00 and 14:30 - 18:00
 <br>
                  Room: Cockle Bay Room, Level 2, ICC Sydney</h3>
                <p>The rise of machine learning (ML) and artificial intelligence (AI) techniques is creating opportunities for space science missions with unprecedented capabilities. By augmenting traditional rule-based decision making with AI techniques (such as
                    decision policies in deep reinforcement learning), robotic missions may become highly autonomous. Furthermore, ML advances will augment the capabilities of crews serving in extended space missions.</p>
                <p><strong>Questions to be explored in this COSPAR 2021 workshop include:</strong></p>
                <ol>
                    <li>How will ML/AI enable autonomous space science missions?</li>
                    <li>What platforms are available for low-power, high-throughput compute in space?</li>
                    <li>How can advances in ML augment human capabilities in crewed missions?</li>
                </ol>
                <p><strong>Speakers</strong></p>
                <div class="row speakers mt-4 mb-4">
                    <div class="chair-image col-4 col-md-2">
                        <img src="img/speakers/m-seablom.png" class="img-fluid">
                    </div>
                    <div class="col col-md-10 chair-text">
                ...
                <div class="row speakers mt-4 mb-4">
                    <div class="chair-image col-4 col-md-2">
                        <img src="img/speakers/s-sukkarieh.jpg" class="img-fluid">
                    </div>
                    <div class="col col-md-10 chair-text">
                ...
                <div class="row speakers mt-4 mb-4">
                    <div class="chair-image col-4 col-md-2">
                        <img src="img/speakers/a-garg.png" class="img-fluid">
                    </div>
                    <div class="col col-md-10 chair-text">
                        <h3>Animesh Garg</h3>
                ...
                <ul>
                    <li>Mark Cheung, Lockheed Martin Advanced Technology Centre, Palo Alto, CA, USA</li>
                    <li>Eric Dixon, Lockheed Martin Advanced Technology Centre, Palo Alto, CA, USA</li>
                    <li>Shashi Jain, Intel, Portland, OR, USA</li>
                    <li>Alison Lowndes, NVIDIA, UK</li>
                    <li>James Parr, NASA Frontier Development Lab (FDL) & FDL Europe</li>
                    <li>Florence Tan, NASA Science Mission Directorate, Washington, DC, USA</li>
                    <li>Animesh Garg, University of Toronto & Vector Institute, Toronto, Canada</li>
                </ul>
                <h2 class="mt-5 mb-4"><a href="https://cospar2020.gitlab.io/cloudcomputing/" target="_blank">Cloud Computing for Space Research</a></h2>
                <h3>Date: Tuesday 2 February 2021<br>Time: 09:30 - 13:00 and 14:30 - 18:00<br> Room: Cockle Bay Room, Level 2, ICC Sydney</h3>
                <p>As space becomes increasingly accessible due to the burgeoning global space industry, the volume of data produced by space research missions is expected to continue rising exponentially.</p>
                <p>Opportunities for accelerating scientific discovery come with challenges in scaling traditional scientific processing workflows. A possible model for addressing such needs is the adoption of cloud compute technologies and open source software. At
                    the same time, the deployment of cloud compute technologies can allow researchers to address calls for scientific reproducibility.</p>
                <p><strong>This COSPAR 2021 workshop will include tutorials and case studies addressing the following questions:</strong></p>
                <ol>
                ...
                <div class="row speakers mt-4 mb-4">
                    <div class="chair-image col-4 col-md-2">
                        <img src="img/speakers/g-miller.png" class="img-fluid">
                    </div>
                    <div class="col col-md-10 chair-text">
                        <h3>Grant Miller </h3>
                ...
                <div class="row speakers mt-4 mb-4">
                    <div class="chair-image col-4 col-md-2">
                        <img src="img/speakers/r-abernathey.jpg" class="img-fluid">
                    </div>
                    <div class="col col-md-10 chair-text">
                        <h3>Ryan Abernathey</h3>
                        <strong>Columbia University and Lamont Doherty Earth Observatory <br>
                            <em>Unlocking the Potential of Cloud Native Science</em></strong>
                        <p>Ryan P. Abernathey is an Associate Professor of Earth And Environmental Science at Columbia University and Lamont Doherty Earth Observatory. He received his Ph.D. from MIT in 2012 and a B.A. from Middlebury College. He joined Columbia in 2013 after a postdoc at Scripps Institution of Oceanography.
                ...
                <p><strong>Technical Organizing Committee (TBC)</strong></p>
                <ul>
                    <li>Mark Cheung, Lockheed Martin Advanced Technology Center, Palo Alto, CA, USA</li>
                    <li>Monica Bobra, Stanford University, CA, USA</li>
                    <li>Jack Ireland, NASA Goddard Space Flight Center, Greenbelt, MD, USA</li>
                    <li>Miho Janvier, Institut d’Astrophysique Spatiale, France</li>
                </ul>
            </div>
        </div>
    </div>
