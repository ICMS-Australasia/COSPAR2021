  ...
  <div class="container">
    <div class="row py-5">
      <div class="col py-4">
        ...
        <div class="sub">
          <a href="pdfs/Virtual-presenter-information.pdf" target="_blank" class="presenter-pdf"><img src="img/presenter-pdf-virtual.jpg" alt="">Download <?php echo $title; ?> PDF</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row py-5 presenter-info">
      <div class="col">
        ...
        <p>All presenters are reminded to register before <strong>30 November 2020</strong>, the early bird Presenter Registration Deadline. In order to be eligible for the early bird presenter rate, presentations will need to be uploaded for inclusion in the virtual conference delivery platform on or before ( no later than) 30 November 2020) .</p>

        <h2 class="mt-5 mb-3">Virtual Platform </h2>

        <p>Further information, including a tutorial video, will be sent to you in due course with instructions for accessing the COSPAR-2021 Hybrid Virtual Platform, for joining your session, participating in and managing live Q&A and more!</p>
