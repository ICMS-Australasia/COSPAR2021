                ...
                <div class="row py-5">
                    <div class="col stem-page">
                      ...
                      <div class="modal fade" id="bland">
                          <div class="modal-dialog modal-dialog-centered modal-lg">
                              <div class="modal-content">
                                  <img src="img/cospark/phil-bland.jpg" width="250">
                                  <h2>Phil Bland</h2>
                                  <h3>Sunday 31 Jan 2021, 10:45am - 11:15am</h3>
                      ...
                      <div class="modal fade" id="johnson">
                          <div class="modal-dialog modal-dialog-centered modal-lg">
                              <div class="modal-content">
                                  <img src="img/cospark/christyl-johnson.jpg" width="250">
                                  <h2>Christyl Johnson</h2>
                                  <h3>Saturday 30 Jan, 2:15pm - 2:45pm</h3>
                      ...
                      <div class="modal fade" id="boyce">
                          <div class="modal-dialog modal-dialog-centered modal-lg">
                              <div class="modal-content">
                                  <img src="img/cospark/russell-boyce.jpg" width="250">
                                  <h2>Russell Boyce</h2>
                                  <h3>Friday 29 Jan 2021, 2:15pm - 2:45pm</h3>
                      ...
                      <div class="modal fade" id="tutt">
                          <div class="modal-dialog modal-dialog-centered modal-lg">
                              <div class="modal-content">
                                  <img src="img/cospark/corey-tutt.jpg" width="250">
                                  <h2>Corey Tutt</h2>
                                  <h3>Monday 1 Feb 2021, 10:45am - 11:15am</h3>
                                  <p>Deadly Science Founder & Indigenous Australian Advocate, the 2020 NSW Young Australian of the Year Corey Tutt, a Kamilaroi man originally from Dapto in the Illawarra confirmed as a Keynote Speaker for COSPAR-K.</p>
                      ...
                      <div class="modal fade" id="harvey">
                          <div class="modal-dialog modal-dialog-centered modal-lg">
                              <div class="modal-content">
                                  <img src="img/cospark/lisa-harvey.png" width="250">
                                  <h2>Lisa Harvey-Smith</h2>
                                  <h3>Sunday 31 Jan 2021, 2:15pm - 2:45pm</h3>
                                  <p>Professor Lisa Harvey-Smith is an award-winning astrophysicist with a talent for making the secrets of the universe accessible to all. She has spent 15 years conducting astrophysics research at universities and research institutes across the world.</p>
                                  ...
                                  <p>Lisa has a talent for presenting complex subject matter in an exciting and accessible way so this is certainly a presentation not to be missed, especially for women and girls considering a career in STEM.</p>
                                  <button type="button" class="close" data-dismiss="modal">x</button>
                              </div>
                          </div>
                      </div>
