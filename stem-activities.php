                    ...
                    <div class="col stem-page">
                      ...
                      <div class="row my-4">
                          <div class="col-md-6 mb-3 mb-md-0">
                              <img src="img/cospark/rover1.jpg" class="img-fluid">
                          </div>
                          <div class="col-md-6 mb-3 mb-md-0">
                      ...
                      <div class="row mt-5 mb-3 align-items-end">
                          <div class="col-7">
                              <h2 class="mb-0">Exploring Habitable Worlds with Praxical</h2>
                          </div>
                          <div class="col">
                      ...
                      <div class="row my-4">
                          <div class="col-md-6 mb-3 mb-md-0">
                              <img src="img/cospark/plants-vs-mars-1.png" class="img-fluid">
                          </div>
                          <div class="col-md-6 mb-3 mb-md-0">
                              <img src="img/cospark/plants-vs-mars-2.png" class="img-fluid">
                          </div>
                      </div>
