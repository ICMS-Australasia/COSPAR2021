                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <img src="img/logo-parkroyal.jpg" alt="" class="float-md-right mb-4 ml-4">
                                <h2 class="mb-4">Koala Competition Winner Announced</h2>

                                <p>We are pleased to announce that
                                    <strong>Siti Harwani Md Yusoff</strong> is
                                    the winner of the Koala Competition. The prize includes complimentary full delegate registration including the COSPAR 2021 social event and five night’s accommodation at a fabulous Assembly Hotel Park Royal, Darling Harbour.</p>
                            </div>
                            <div class="col-md-12" id="gallery">
                                <div class="koalabox">
                                    ...
                                    <p>
                                        ...
                                        Kampar, Perak, Malaysia (at 10 km in altitude)
                                    </p>
                                    <p>
                                        <strong>Entrant:</strong>
                                        Siti Harwani Md Yusoff, Malaysia</p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="koalabox">
                                    ...
                                    <p>
                                        <strong>Location:</strong>
                                        Stanley, New Mexico, United States of America
                                    </p>
                                    <p>
                                        <strong>Entrant:</strong>
                                ...
                                <div class="koalabox">
                                    ...
                                    <p>
                                        <strong>Location:</strong>
                                        James Thomason Building at Indian Institute of Technology Roorkee, Uttarakhand, India
                                    </p>
                                    <p>
                                        <strong>Entrant:</strong>
                            ...
                            <div class="col-lg-4">
                                <div class="koalabox">
                                    ...
                                    <p>
                                        <strong>Location:</strong>
                                        Caltech Campus (Keck Institute for Space Studies), California, USA
                                    </p>
                                    <p>
                                        <strong>Entrant:</strong>
                                ...
                                <div class="koalabox">
                                    ...
                                    <p>
                                        <strong>Location:</strong>
                                        NASA's "Neil Gehrels Swift Satellite"
                                    </p>
                                    <p>
                                        <strong>Entrant:</strong>
                            ...
                            <div class="col-lg-4">
                                <div class="koalabox">
                                    ...
                                    <p>
                                        <strong>Location:</strong>
                                        European Space Research and Technology Center - ESTEC, Noordwijk, The Netherlands
                                    </p>
                                    <p>
                                        <strong>Entrant:</strong>
