<div class="row stem-cards mt-5">
  ...
  <a href="./stem-activities-rocketrescue.php" class="col-sm-6 col-12 col-md-4">
    <div class="stem-card">
      <img class="img-fluid" src="img/cospark/activity-card2.jpg">
      <h3 class="stem-card-title p-4">Rocket Rescue</h3>
    </div>
  </a>
  <a href="./stem-activities-roboticrecovery.php" class="col-sm-6 col-12 col-md-4">
    <div class="stem-card">
      <img class="img-fluid" src="img/cospark/activity-card8.jpg">
      <h3 class="stem-card-title p-4">Robotic Recovery Mission</h3>
    </div>
  </a>
  <a href="./stem-activities-daleksandrobots.php" class="col-sm-6 col-12 col-md-4">
    <div class="stem-card">
      <img class="img-fluid" src="img/cospark/activity-card9.jpg">
      <h3 class="stem-card-title p-4">Daleks & Robots</h3>
    </div>
  </a>
  <a href="./stem-activities-giantmoon.php" class="col-sm-6 col-12 col-md-4">
    <div class="stem-card">
      <img class="img-fluid" src="img/cospark/activity-card5.jpg">
      <h3 class="stem-card-title p-4">Giant Moon & Mars Maps</h3>
    </div>
  </a>
  ...
  <a href="./stem-activities-droneracing.php" class="col-sm-6 col-12 col-md-4">
    <div class="stem-card">
      <img class="img-fluid" src="img/cospark/activity-card3.jpg">
      <h3 class="stem-card-title p-4">Drone Racing</h3>
    </div>
  </a>
  <a href="./stem-activities-satellitemission.php" class="col-sm-6 col-12 col-md-4">
    <div class="stem-card">
      <img class="img-fluid" src="img/cospark/activity-card4.jpg">
